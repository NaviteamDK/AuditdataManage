...
| `ADM Sale Buffer Header` (80307) | Staging header for imported sales |
| `ADM Sale Buffer Line` (80308) | Staging lines for imported sales |
| `ADM Master Order Header` (80309) | Promoted orders awaiting split + fulfillment |
| `ADM Master Order Line` (80310) | Lines on a master order |
