page 80312 "ADM Master Order Card"
{
    ...
    actions
    {
        area(Processing)
        {
            ...
            action(RecalcSplit)
            {
                ...
                Image = Refresh;
                Enabled = (Rec."Split Status" = Rec."Split Status"::"Split Suggested") or (Rec."Split Status" = Rec."Split Status"::"Split Confirmed");
    ...
    begin
        ...
        CalcDifference := Rec."Total Amount" - Rec.GetSplitTotal();
        if Abs(CalcDifference) < 0.01 then begin
        ...
        CanCreateOrdersExpr := Rec.CanCreateOrders();
    end;
